...
module.exports = ScriptBase.extend({
    ...
    createFactoryFiles: function createFactoryFiles() {
        ...
        var createFiles = function(props) {
            ...
            this.generateSourceAndTest('component');
                ...
                [
                    {
                        type: 'confirm',
                        name: 'createTemplate',
                        message: 'Would you like to create a html-template-file and a scss-file for the component?',
                        default: defaults.createTemplate
                    },
                    {
                        type: 'list',
                        name: 'createService',
                        message: 'Would you like to create a service or factory for the component?',
